...
Welcome to my repository for the **LeetCode SQL 50 Study Plan**! This repository contains clean, optimized, and well-structured T-SQL / SQL Server solutions for fundamental to advanced relational database problems.
...
* **Goal:** Master SQL queries, data aggregation, JOINs, Window Functions, CTEs, and query optimization.
* **Topics Covered:** 
  * Select & Basic Joins
  * Basic & Advanced Aggregate Functions
...
* **CTEs & Subqueries:** Modularizing complex logic for readability and performance.
* **Set Operations:** Efficient use of `UNION ALL` over `UNION` to preserve records and maximize performance.
* **Filtering & Ranking:** Leveraging `TOP`, `ORDER BY`, `DENSE_RANK()`, and window functions.
...
|  |
| ------- |
| [0176-second-highest-salary](https://github.com/nasim-ahmmed19/Suty-Plan-SQL-50/tree/master/0176-second-highest-salary) |
...
| [0585-investments-in-2016](https://github.com/nasim-ahmmed19/Suty-Plan-SQL-50/tree/master/0585-investments-in-2016) |
...
| [0602-friend-requests-ii-who-has-the-most-friends](https://github.com/nasim-ahmmed19/Suty-Plan-SQL-50/tree/master/0602-friend-requests-ii-who-has-the-most-friends) |
...
| [1327-last-person-to-fit-in-the-bus](https://github.com/nasim-ahmmed19/Suty-Plan-SQL-50/tree/master/1327-last-person-to-fit-in-the-bus) |
...
| [1462-list-the-products-ordered-in-a-period](https://github.com/nasim-ahmmed19/Suty-Plan-SQL-50/tree/master/1462-list-the-products-ordered-in-a-period) |
...
| [1625-group-sold-products-by-the-date](https://github.com/nasim-ahmmed19/Suty-Plan-SQL-50/tree/master/1625-group-sold-products-by-the-date) |
| [1664-find-users-with-valid-e-mails](https://github.com/nasim-ahmmed19/Suty-Plan-SQL-50/tree/master/1664-find-users-with-valid-e-mails) |
